...
use Evotic\SolusSDK\Interfaces\Servers\ISolusServerCustomPlanParameters;
use Evotic\SolusSDK\Interfaces\Servers\Backups\ISolusServerBackupSettings;

interface ISolusPlanCreateOptions {
    ...
    public function setVirtualizationType(?string $virtualizationType): self;
...
class SolusPlanCreateOptions implements ISolusPlanCreateOptions {
    ...
    public function setStorageType(?string $storageType): self {
        return $this->setOption('storage_type', $storageType);
    }

    public function setImageFormat(?string $imageFormat): self {
        return $this->setOption('image_format', $imageFormat);
    }
    ...
    public function setVirtualizationType(?string $virtualizationType): self {
        return $this->setOption('virtualization_type', $virtualizationType);
    }
